...
#> 182401     mva kmeans    1.0.1 closure     TRUE     <NA>   FALSE
#> 199823   stats kmeans    1.9.0 closure     TRUE function   FALSE
#> 199827   stats kmeans    2.1.0 closure     TRUE function   FALSE
#> 199866   stats kmeans    3.0.2 closure     TRUE function   FALSE
#> 199871   stats kmeans    3.2.0 closure     TRUE function   FALSE
#>                                                                                                                              args
#> 182401                                                                                                (x, centers, iter.max = 10)
#> 199823                                                                                                (x, centers, iter.max = 10)
#> 199827                  (x, centers, iter.max = 10, nstart = 1, algorithm = c("Hartigan-Wong",     "Lloyd", "Forgy", "MacQueen"))
#> 199866   (x, centers, iter.max = 10, nstart = 1, algorithm = c("Hartigan-Wong",     "Lloyd", "Forgy", "MacQueen"), trace = FALSE)
#> 199871 (x, centers, iter.max = 10L, nstart = 1L, algorithm = c("Hartigan-Wong",     "Lloyd", "Forgy", "MacQueen"), trace = FALSE)
```
